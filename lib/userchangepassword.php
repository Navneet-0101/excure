...
<div class="banner-text agileinfo about-bnrtext">
    <div class="container">
        <h2><a href="index.html">Home</a> /Admin Home</h2>
    </div>
</div>
<!-- //banner-text -->
</div>
    ...
    <div class="col-md-6 col-md-offset-3">
        <form action="updateuserpassword.php" method="post">
            ...
            <div class="form-group">
                ...
                {
                    if($_REQUEST["msg"]==1)
                        echo"<div class='alert alert-success text-center'><strong>Password Changed</strong></div>";
                    elseif($_REQUEST["msg"]==0)
                        echo"<div class='alert alert-danger text-center'><strong>Password Change Failed</strong></div>";
                    elseif($_REQUEST["msg"]==2)
                        echo"<div class='alert alert-danger text-center'><strong>Old password incorrect</strong></div>";
                    elseif($_REQUEST["msg"]==3)
                        echo"<div class='alert alert-danger text-center'><strong>Email id incorrect</strong></div>";
                }
                ?>
            </div>
