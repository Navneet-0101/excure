...
<div class="banner-text agileinfo about-bnrtext">
    <div class="container">
        <h2><a href="index.php">Home</a> /Edit Buses</h2>
    </div>
</div>
<!-- //banner-text -->
</div>
...
<div class="container">
    <div class="col-md-8 col-md-offset-2 bus">
        <form action="updatebuses.php" method="post">
            <h4 class="text-center" style="font-style:italic">Bus Details</h4>
            <div class="col-md-8">
                <div class="form-group">
                    <label>Bus Name</label>
                    <input type="text" name="tbbusname" id="tbbusname" class="form-control" value="<?php echo $row[1];?>"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="tbregno" id="tbregno" class="form-control" value="<?php echo $row[2];?>"
                      readonly     data-rule-required="true" data-msg-required="Reg.No. is required.">
                </div>
            </div>
            <div class="col-md-8">
                <div class="form-group">
                    <label>Mobile</label>
                    <input type="text" name="tbmob" id="tbmob" class="form-control" value="<?php echo $row[4];?>"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label>Price</label>
                    <input type="text" name="tbprice" id="tbprice" class="form-control" value="<?php echo $row[3];?>"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select id="tbdays" name="tbdays[]" data-rule-required="true" class="form-control"
                            ...
                            <option value="sunday" <?php echo checkva("sunday");?>>Sunday</option>
                            <option value="monday" <?php echo checkva("monday");?>>Monday</option>
                            <option value="tuesday" <?php echo checkva("tuesday");?>>Tuesday</option>
                            <option value="wednesday" <?php echo checkva("wednesday");?>>Wednesday</option>
                            <option value="thursday" <?php echo checkva("thursday");?>>Thursday</option>
                            <option value="friday" <?php echo checkva("friday");?>>Friday</option>
                            <option value="saturday" <?php echo checkva("saturday");?>>Saturday</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="time" name="tbtime" id="tbtime" class="form-control"  value="<?php echo $row[10];?>"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select id="tbtype" name="tbtype" data-rule-required="true" class="form-control"
                            ...
                            <option>Volvo AC Semi Sleeper</option>
                            <option>Mercedes First Class AC Sleeper</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="tbdrivername" id="tbdrivername" class="form-control" value="<?php echo $row[5];?>"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="tbdrivermob" id="tbdrivermob" class="form-control" value="<?php echo $row[6];?>"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="tbemerno" id="tbemerno" class="form-control" value="<?php echo $row[22];?>"
            ...
            <div class="col-md-4    ">
                <div class="form-group">
                    <label>MTicket</label>
                    <input type="radio" checked name="tbticket" id="tbyes" <?php if($row[12]=="yes"){echo "checked";} ?> value="yes" data-rule-required="true"><label>Yes</label>
                    <input type="radio" name="tbticket" id="tbno" <?php if($row[12]=="no"){echo "checked";} ?> value="no" data-rule-required="true"><label>No</label>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label>CCTV</label>
                    <input type="radio" checked name="tbcctv" id="tbyes" <?php if($row[21]=="yes"){echo "checked";} ?> value="yes" data-rule-required="true"><label>Yes</label>
                    <input type="radio" name="tbcctv" id="tbno" <?php if($row[21]=="no"){echo "checked";} ?>value="no" data-rule-required="true"><label>No</label>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label>Heater</label>
                    <input type="radio" checked name="tbheater" id="tbyes" <?php if($row[17]=="yes"){echo "checked";} ?>value="yes" data-rule-required="true"><label>Yes</label>
                    <input type="radio" name="tbheater" id="tbno" <?php if($row[17]=="no"){echo "checked";} ?> value="no" data-rule-required="true"><label>No</label>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label>Hammer</label>
                    <input type="radio" checked name="tbhammer" id="tbyes" <?php if($row[20]=="yes"){echo "checked";} ?>value="yes" data-rule-required="true"><label>Yes</label>
                    <input type="radio" name="tbhammer" id="tbno" <?php if($row[20]=="no"){echo "checked";} ?>value="no" data-rule-required="true"><label>No</label>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label>Blanket</label>
                    <input type="radio" checked name="tbblanket" id="tbyes"<?php if($row[14]=="yes"){echo "checked";} ?> value="yes"
                           data-rule-required="true"><label>Yes</label>
                    <input type="radio" name="tbblanket" id="tbno" <?php if($row[14]=="no"){echo "checked";} ?> value="no"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label>Water</label>
                    <input type="radio" checked name="tbwaterbottle" id="tbyes"  <?php if($row[13]=="yes"){echo "checked";} ?>value="yes"
                           data-rule-required="true"><label>Yes</label>
                    <input type="radio" name="tbwaterbottle" id="tbno" <?php if($row[13]=="no"){echo "checked";} ?> value="no"
                           data-rule-required="true"><label>No</label>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="radio" checked name="tbreading" id="tbyes"<?php if($row[16]=="yes"){echo "checked";} ?> value="yes"
                           data-rule-required="true"><label>Yes</label>
                    <input type="radio" name="tbreading" id="tbno" <?php if($row[16]=="no"){echo "checked";} ?>value="no"
                           data-rule-required="true"><label>No</label>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="radio" checked name="tbexit" id="tbyes" <?php if($row[18]=="yes"){echo "checked";} ?> value="yes" data-rule-required="true"><label>Yes</label>
                    <input type="radio" name="tbexit" id="tbno" <?php if($row[18]=="no"){echo "checked";} ?> value="no" data-rule-required="true"><label>No</label>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label>Fire Extinguisher</label>
                    <input type="radio" checked name="tbfire" id="tbyes" <?php if($row[19]=="yes"){echo "checked";} ?>value="yes" data-rule-required="true"><label>Yes</label>
                    <input type="radio" name="tbfire" id="tbno"<?php if($row[19]=="no"){echo "checked";} ?> value="no" data-rule-required="true"><label>No</label>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="radio" checked name="tbcharging" id="tbyes"<?php if($row[15]=="yes"){echo "checked";} ?> value="yes" data-rule-required="true"
                           data-msg-required="*"><label>Yes</label>
                    <input type="radio" name="tbcharging" id="tbno" <?php if($row[15]=="no"){echo "checked";} ?>value="no"
                           data-rule-required="true"><label>No</label>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <input type="submit" value="Update bus" class="btn btn-primary btn-block">
                    <?php
